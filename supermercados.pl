% https://docs.google.com/document/d/1jzWOicSJuRQmt7acFHWgLvBiEO4m7wZx5Wk2JveWxlg/edit#heading=h.hmai6pnwlme4
...
descuento(salchichas(Marca, Cantidad), 0.5):- producto(salchichas(Marca, Cantidad)), Marca \= vienisima.
